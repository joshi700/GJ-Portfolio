    ...
    <Container fluid className="home-about-section" id="about">
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            <h1 style={{ fontSize: "2.3em", lineHeight: "1.3" }}>
              Regional Product Manager driving innovation in{" "}
              <span className="purple">Payment Gateway</span> solutions
            </h1>
      ...
      <Container>
        <div className="section-title-wrapper">
          <h1 className="section-heading-styled">Moments &amp; Memories</h1>
        </div>
        <Carousel />
      </Container>
    </Container>
